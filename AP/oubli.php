...
function passgen1($nbChar) {
    ...
    // Initialiser une variable vide pour stocker le mot de passe
    $pass = '';
       // Boucle pour ajouter un caractère aléatoire à la chaîne du mot de passe pour chaque itération jusqu'à ce que la longueur souhaitée soit atteinte
    for($i = 0; $i < $nbChar; $i++){
         // Ajouter un caractère aléatoire à la chaîne du mot de passe
...
try {
    ...
    echo "Erreur de connexion : " . $e->getMessage();
        ...
        if ($trouve == 1) {
            ...
            // Hachage MD5 avec un salage
            $salt_md5 = '$1$duSel';
            $hashed_md5 = crypt($mdpnew, $salt_md5);
            echo "Mot de passe: $hashed_md5 <br>";
